...
# Insertar "Nuevo texto" antes de la línea 3
sed -i '3i Nuevo texto' "archivo.txt"

# Conservar solo las líneas que contienen "INFO"
sed -i '/INFO/!d' archivo.txt

# Eliminar todas las líneas que contienen "ERROR"
sed -i '/ERROR/d' archivo.txt

# Reemplazar todo desde "inicio" hasta el final de la línea por "nuevo texto"
